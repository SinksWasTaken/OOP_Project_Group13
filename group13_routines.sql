...
--
-- Dumping events for database 'group13'
--

--
-- Dumping routines for database 'group13'
--
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `addSession`(sdate DATE, stime TIME, shall INT)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `InsertSeats` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`myuser`@`localhost` PROCEDURE `InsertSeats`()
BEGIN
    DECLARE counter INT DEFAULT 1;
    DECLARE seat_c INT DEFAULT 1;
    DECLARE seat_r CHAR(1);
    DECLARE hall INT DEFAULT 2;

    SET seat_r = 'a';

    WHILE counter <= 64 DO
        INSERT INTO seats (sold, hall, c, r, session_id)
        VALUES (0, hall, seat_c, seat_r, 1);
        ...
        IF seat_r = 'd' THEN
            ...
            SET seat_c = seat_c + 1;
        ELSE
            SET seat_r = CHAR(ASCII(seat_r) + 1);
        END IF;
